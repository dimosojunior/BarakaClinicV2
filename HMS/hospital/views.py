...
def Clinic_services_Page(request):
    #title = 'List of Vipimo'
    services = ClinicServices.objects.all().order_by('-id')
    ...
    if request.method == 'POST':
        services = ClinicServices.objects.filter( ServiceName__icontains=form['ServiceName'].value())
